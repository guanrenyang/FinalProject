...
GraphModifier::GraphModifier(Q3DBars *bargraph)
    : m_graph(bargraph),
      ...
      m_maxval(20.0f),
      //! [1]
      m_temperatureAxis(new QValue3DAxis),//订单数量
      m_yearAxis(new QCategory3DAxis),//每个grid
      m_monthAxis(new QCategory3DAxis),//每小时
      m_primarySeries(new QBar3DSeries),//出发量
      m_secondarySeries(new QBar3DSeries),//到达量
      //! [1]
